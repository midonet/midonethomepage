...
# TODO Update the tarball url once it is available
TARBALL_URL=https://github.com/saptaktakalkar/midonet-quickstart/blob/master/quickstart-ansible.tar.gz?raw=true
